---
title: "XAI Bayesian Teaching Scientific Reports main analyses"
output:
...
dev.copy(svg, "../output/Fig3.svg", width = 21, height = 9)
dev.off()
```
...
dev.copy(svg, "../output/Fig4.svg", width = 21, height = 7)
dev.off()
```
...
dev.copy(svg, "../output/Fig5.svg", width = 20, height = 15)
dev.off()
```
...
dev.copy(svg, "../output/Fig6.svg", width = 16, height = 14)
dev.off()
```
